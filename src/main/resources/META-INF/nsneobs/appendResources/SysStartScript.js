/**系统启动后的脚本,scriptUtils 是系统注入的工具,有一个接口函数 exucteUpdate*/
scriptUtils.println("这是一个系统系统后调用的脚本,负责在系统初始的时候进行系统初始化操作,如创建视图等...开始");
...
scriptUtils.println("这是一个系统系统后调用的脚本,负责在系统初始的时候进行系统初始化操作,如创建视图等...结束");