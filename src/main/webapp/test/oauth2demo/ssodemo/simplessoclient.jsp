...
<%
    //定义单点登录服务器地址
    String ssoServer = "http://117.50.19.70:9999/smart-sso-server";
    String tokenServer = "http://117.50.19.70:9999/smart-sso-server";
    String userServer = "http://117.50.19.70:9999/smart-sso-server";
%>
<div class="titlediv">
    <table>
        <tr><td>本页地址</td><td>http://localhost:8080/test/oauth2demo/ssodemo/simplessoclient.jsp</td></tr>
...
<%
    ...
    if(StringUtils.isBlank(code)){
        ...
        if(StringUtils.isBlank(user)){
            ...
            response.setHeader("location",ssoServer+"?callback=http://localhost:8080/test/oauth2demo/ssodemo/simplessoclient.jsp");
            return;
        }else{
            //已登录,正常显示
%>
