...
public class RandomCodeUtil {
    ...
    public static BufferedImage createCodeImage(int w, int h, String code) throws Exception {
        int verifySize = code.length();
        BufferedImage image = new BufferedImage(w, h, BufferedImage.TYPE_INT_RGB);
        Random rand = new Random();
        Graphics2D g2 = image.createGraphics();
    ...
    public static void base64ToImage(String base64) {
        ...
        try {
            File file = new File("D:/verifyImages/test.jpg");
...
//        System.out.println("验证码对应的码为:"+code);
//        //生成校验码图片
//        BufferedImage image = createCodeImage(120,40,code);
//        //将验证码图片转成base64字符串
//        String base64 = imageToBase64(image);
//        System.out.println("验证码对应的base64为"+base64);
//        //将base64字符串转为图片保存到本地
